...
export function HeroSection() {
  return (
    <section
      id="home"
      className="relative mx-auto flex max-w-360 flex-col overflow-hidden px-6 pb-16 pt-22 lg:min-h-screen lg:justify-center lg:pt-32"
    >
      {/* ambient glow */}
      <div
        aria-hidden
      ...
      <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_1fr]">
        ...
        <div className="min-w-0 animate-fade-in-up space-y-7">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <StatCard value={site.stats.brands} label="DTC Brands served" />
